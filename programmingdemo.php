    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <h1 style="color: white;margin-top: 10px;" id="myhead">Study Tour</h1>
            </div>
            <div class="collapse navbar-collapse" id="navi">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li> <a
                            style="text-decoration: none;text-transform:none"><?php echo "Hi " . $_SESSION['username']; ?></a>
                    </li>
...
<div>
    ...
    <section class="latest-news-area" id="latest">
        <div class="container">
            ...
            mysqli_select_db($con, 'studytour');
    ...
    <footer class="section footer-classic context-dark bg-image" style="background: #2d3246;padding:5px">
        <div class="container" style="margin-top: 20px;">
            <div class="row row-30">
                <div class="col-md-4 col-xl-5">
                    <div class="pr-xl-4"><a class="brand" href="index.html"><img style="padding:px;border-radius:10px"
                                class=" brand-logo-light" src="./img/study logo.png" alt="" width="140" height="87"
                                srcset="./img/study logo.png 2x"></a>
                        <p>Study Tour is an excellent learning hub, dedicated to the programmer who want to
                            explore.</p>
                        <!-- Rights-->
                        <p class="rights"><span>©  </span><span
                                class="copyright-year">2022</span><span> </span><span>Study
                                Tour</span><span>. </span><span>All
                ...
                <div class="col-md-4">
                    ...
                    <dl class="contact-list">
                        <dt>Address:</dt>
                        <dd>GLA University, Mathura</dd>
                    </dl>
                    <dl class="contact-list">
                        <dt>email:</dt>
                        <dd><a href="mailto:#">studytour@gmail.com</a></dd>
                    </dl>
                    <dl class="contact-list">
                        <dt>phones:</dt>
                        <dd><a href="tel:#">+91 7323961094</a> <span>or</span> <a href="tel:#">+91 8561872250</a>
                        </dd>
                    </dl>
                </div>
        ...
        <div class="row no-gutters social-container">
            ...
            <div class="col"><a class="social-inner" href="https://www.twitter.com"><span
