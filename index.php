...
<body onload="myfunction()">
    ...
    <section class="slider text-center" class="slider">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="service-wrap text-center">
                        ...
                        <p>
                            Here you will find problem programs for practice and their implementation also which
                            will
            ...
            <div class="col-md-12">
                <div id="team-memebers" class="owl-carousel owl-theme">
                    <div class="team-member text-center">
                        <img src="img/my1.jpg" class="img-responsive">
                        <div class="team-member-info text-center">
                            <h4 class="team-member-name">Lalit Saini</h4>
                            <h4 class="team-member-designation">ceo</h4>
                            <ul class="social-list">
                                <li><a href="https://www.facebook.com" class="social-icon icon-gray"><i
                                            class="fa fa-facebook"></i></a></li>
                                <li><a href="https://twitter.com" class="social-icon icon-gray"><i
                    ...
                    <div class="team-member text-center">
                        <img src="img/mukul.jpeg" class="img-responsive">
                        <div class="team-member-info text-center">
                            <h4 class="team-member-name">Mukul Agarawal</h4>
                    ...
                    <div class="team-member text-center">
                        <img src="img/pallav.jpg" class="img-responsive">
                        <div class="team-member-info text-center">
                            <h4 class="team-member-name">Pallav Raj</h4>
                    ...
                    <div class="panel-group" id="accordian">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
                                <div class="panel-body">
                                    <p>
                                        Study Tour is an online E-learning website <br>
