            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class=" card-header card-primary p-1">
                        <h2 class="text-success text-center">WELCOME TO STUDY TOUR</h2>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card" style="box-shadow: 2px 2px 2px 2px #dfdfdf;">
                    <div class="card-header bg-primary text-light p-2 ">
                        <h3>login form</h3>
                    </div>
                    <?php 
                    ...
                    <div class="card-body p-2 small">
                        <form action="signup_submit.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="email" placeholder="upload your image"
                                    name="img">
                            </div>
