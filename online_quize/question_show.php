 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top position-relative">
     ...
     <a class="navbar-brand text-white" href="../index.php">Study Tour</a>
        ...
        <a class="nav-link text-white" href="#">Link</a>
             ...
             <li class="nav-item dropdown">
                 ...
                 <div class="dropdown-menu text-white fade" aria-labelledby="navbarDropdown">
                     ...
                     <a class="dropdown-item" href="../video tutorials/java/display_video_courses.php">Videos
                         tutorials</a>
         ...
         <form action="result_show.php" method="POST" id="myform" style="margin-top: -400px;">
             ...
             <center>
                 <div class="row col-sm-7 ">
                     <script type="text/javascript">
                     var timeleft = 1 *
                         60; //important--> the scope of javascript variable is global but not in php(we have to use global keyword)
                     </script>
 ...
 ?>
                     <table class="table table-hover table-bordered table-active">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 <td scope="row"><input type="radio" value="0"
                                         name="<?php echo $quest['id']; ?>" />&emsp;<?php echo $quest['opt1']; ?></td>
                             </tr>
                             <?php } ?>
                             <?php if (isset($quest['opt2'])){ ?>
                             <tr>
                                 <td scope="row"><input type="radio" value="1"
                                         name="<?php echo $quest['id']; ?>" />&emsp;<?php echo $quest['opt2']; ?></td>
                             </tr>
                             <?php } ?>
                             <?php if (isset($quest['opt3'])){ ?>
                             <tr>
                                 <td scope="row"><input type="radio" value="2"
                                         name="<?php echo $quest['id']; ?>" />&emsp;<?php echo $quest['opt3']; ?></td>
                             </tr>
                             <?php } ?>
                             <?php if (isset($quest['opt4'])){ ?>
                             <tr>
                                 <td scope="row"><input type="radio" value="3"
                                         name="<?php echo $quest['id']; ?>" />&emsp;<?php echo $quest['opt4']; ?></td>
                             </tr>
                             <?php } ?>

                             <tr>
                                 <td scope="row"><input type="radio" checked="checked" style="display: none;"
                                         value="no_attempt" name="<?php echo $quest['id']; ?>" /></td>
                                 <!-- bydefautlt select this if no other answer are selected -->
                             </tr>
                         </tbody>
                     </table>
                     <?php 
