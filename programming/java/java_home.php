    ...
    <div id="mainpagecontent">
        ...
        <div class="content">
            <h4 style="font-family: 'Assistant', sans-serif;" class="content">
                ...
                <br>
                <h3 style="font-family: 'Rubik', sans-serif; font-style: bold; color:orangered;" class="text-center">
                    Audience</h3><br>
                This tutorial has been prepared for the beginners to help them understand the basic to advanced concepts
                related to Java Programming language.

                <br>
                <h3 class="text-center" style="font-style: bold;color:orangered;">Prerequisites</h3><br>
                Before you start practicing various types of examples given in this reference, we assume that you are
                already aware about computer programs and computer programming languages.
