                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane container active" id="home">
                        <div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1"
                            style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b>YOUR COURSES</b></div><br>
                        <div class="row">
                                        ...
                                        <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="two-tab" data-toggle="tab" href="#two"
                                                    role="tab" aria-controls="Two" aria-selected="false">UPDATE</a>
                                            </li>
                                            <li class="nav-item">
				  ...
				  <form action=" video_add.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
                                                        ...
                                                        <div class="">
                                                            <button type="submit" class="btn btn-danger"
                                                                name="btn_add_vid">Submit</button>
                                                        </div>
                                                        </form>
                                                    ...
                                                    <div class="card-body small">
                                                        ...
                                                        <form action="video_add.php" method="post"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label for="exampleFormControlSelect1">Select video
                                                                    Course Name :</label>
							 ...
							 {
										?>
                                                                    <option><?php echo  $course_list['course_name']; ?>
                                                                    </option>
                                                                    <?php } ?>
                                                            ...
                                                            <div class="">
                                                                <button type="submit" class="btn btn-danger"
                                                                    name="btn_update_vid">Submit</button>
                                                            </div>
                                                        </form>
                                                                ...
                                                                <?php  foreach ($video as $course_list)
							 {
										?>
                                                        ...
                                                        <div class="float-left">
                                                            <button type="submit" class="btn btn-danger"
                                                                name="btn-delete-vid">Submit</button>
                                                        </div>
                                                        </form>
