    ...
    <div class="container-fluid" style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-md-10 ">
                ...
                <div>
                    <h3 class="text-center mt-2">Manage Your <?php  echo $_GET['course_name'];  ?> &nbsp online video
                        tutorial</h3>
                    <button class="btn btn-primary float-right" data-toggle="modal" data-target="#myModal">add new
                        video</button><br>
                </div>
                    ...
                    <div class="col-md-4 p-3">
                        <div class="card shadow mycard" style="width: 18rem; height: 7rem;">
                            <div class="inner">
                                ...
                                <img class="card-img-top " style="height: 11rem;" src=<?php echo $row['video_image']; ?>
                                    alt="Card image cap">
                            </div>
                            ...
                            <div class="card-body shadow" style="background-color: #f1f1f1;">
                                ...
                                <span class="text-danger" style="font-size: 14px; ">
                                    <a href="watch_video.php?video_id=<?php echo $row['video_id'] ?>&course_name=<?php echo $row['course_name'] ?>"
                                        class="text-success p-1" style="text-decoration: none;">watch <i
                                            class="fa fa-eye"></i></a>

                                    <a href="" class="p-1 text-primary" style="text-decoration: none;">update<i
                                            class="fa fa-pencil ml-1"></i></a>

                                    <a href="video_add.php?id=<?php echo $row['video_id']?>&course_name=<?php echo $row['course_name'] ?>&run=delete"
                                        class="p-1 text-danger" name="delete_vid"
                                        style="text-decoration: none;">delete<i class="fa fa-trash-o ml-1"></i></a>
                                </span>
                            </div>
                        </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-danger"
                                                name="btn_add_new_vid">Add</button> <!-- data-dismiss="modal" -->
                                        </div>
                                </form>
                            </div>
                        </div>
