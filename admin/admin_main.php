...
<body style="background-color:#f1efef">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
        <a class="navbar-brand text-white" href="#">Study Tour</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto ">
                <li class="nav-item active">
                    <a class="nav-link text-white" href="../../studytour/admin/admin_main.php">Home <span
        ...
        <div class="row">
            <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar">
                <ul class="list-group text-white sidebar-list">
                    ...
                    <li class="list-group-item bg-dark "><a href="manage_courses/manage_courses.php">Manage Courses</a>
                    </li>
            ...
            <div class=" col-md-10">
                <div class="card-header bg-white" style="margin-right: -45px; height: 60px;">
                    <b>DASHBOARD</b>
                    <button type="btn btn-outline-success" class="btn btn-primary float-right" style="height: 40px;"><a
                            href="../login.php" class="text-white ">Logout</a> </button>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-4 mt-3 ml-5">
                        <div class="card shadow "
                            style="width: 18rem; box-shadow: 1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px; cursor:pointer;">
                ...
                Your Courses
                            ...
                            <div class="card-body">
                                <p class="card-text"><a href="manage_courses/manage_courses.php"
                                        style="text-decoration: none;">MANAGE YOUR COURSE <i
                                            class="fa fa-book ml-3"></i></a></p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mt-3">
                        <div class="card shadow"
                            style="width: 18rem;cursor:pointer; box-shadow:1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px;">
                            <!-- <div class="card-header">
                Your Courses
              </div> -->
                            ...
                            <div class="card-body">
                                <p class="card-text "><a href="manage_videos/manage_videos.php"
                                        style="text-decoration: none; color: orangered">MANAGE YOUR VIDEOS</a><i
                                        class="fa fa-video-camera ml-3" style="color: orangered"></i></p>
                            </div>
                        </div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <td class="mytable1">
                                        <div class="card shadow border-0 "
                                            style="width: 15rem; height: 110px; box-shadow: 2px 3px #827171; border-radius:0px; border-top-left-radius: 0px;">

                                            <div class="card-body">
                                                <p class="card-text text-white"><b class="h4">No. Of Courses
                                                    </b><br><span
                                                        style="font-size: 20px;"><?php $admin->display_course_count(); ?></span>
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td class="mytable2">
                                        <div class="card shadow border-0"
                                            style="width: 15rem; height: 110px; box-shadow: 2px 2px #827171; border-radius:0px; border-top-left-radius: 0px;">

                                            <div class="card-body">
                                                <p class="card-text text-white"><b class="h4">No. Of Videos</b><br><span
                                                        style="font-size: 20px;"><?php $admin->display_video_count(); ?></span>
                                                </p>
                                            </div>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-3 mt-5 ml-5">
                        <div class="card shadow"
                            style="width: 15rem; height:22rem; box-shadow:1px 1px 1px 1px #e1dbdb; border-radius:0px; border-top-left-radius: 0px;">
                            <!-- <div class="card-header">
                Your Courses
              </div> -->
                            ...
                            <div class="card-body">
                                <p class="card-text "><a href="manage_quiz/manage_quiz.php"
                                        style="text-decoration: none; color: orangered">MANAGE YOUR QUIZ</a></p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8 ml-5">
                        ...
                        <table class="table bg-white"
                            ...
                            <thead>
                                <tr>
                                    <th>id</th>
                                    <th scope="col">MANAGE FAQs <a href="" class="float-right"
                                            style="text-decoration: none;">Edit</a></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr style="width: 500px;">
                                    ...
                                    <td><?php echo $faq_list['faq_title']; ?><br>
                                        <blockquote class="rounded p-2 text-muted "
                                            style="font-size: 13px; background-color: #db6a8f57;">
                                            <?php echo $faq_list['faq_description']; ?></blockquote>
                                    </td>
                                </tr>
