...
<body onload="">
            ...
            <div class="col-md-10 ">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane container active" id="home">
                        <div class="card-header mt-3 mr-5 bg-white text-info border-0 shadow card1 text-center"
                            style="width: 1050px; box-shadow: 1px 1px 1px 1px #ccc"><b class="text-center">YOUR ONLINE
                                QUIZE COURSES</b></div><br>
 ...
 ?>
                                            ...
                                            <option value="<?php echo $quiz['id'] ;?>"><?php echo $quiz['cat_name']; ?>
                                        ...
                                        <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link" id="one-tab" data-toggle="tab" href="#one"
                                                    role="tab" aria-controls="One" aria-selected="true">ADD</a>
                                            </li>
                                            <!--  <li class="nav-item">
				  ...
				  <form action=" quiz_add.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="c_name"
                                                                placeholder="Enter Subject Name" name="course_name">
                                                            <span id="name_error"
                                                        ...
                                                        <div class="">
                                                            <button type="submit" class="btn btn-danger"
                                                                name="btn_add_quiz_sub">Submit</button>
                                                        </div>
                                                        </form>
				  ...
				  <form action=" quiz_add.php" method="post" enctype="multipart/form-data">
								 ...
								 ?>
                                                                ...
                                                                <option value="<?php echo $quiz['id'] ;?>">
                                                                    <?php echo $quiz['cat_name']; ?></option>
                                                                <!-- displaying course name in dropdown -->
								      ...
								      ?>
                                                        ...
                                                        <div class="float-left">
                                                            <button type="submit" class="btn btn-danger"
                                                                name="btn_delete_quiz_sub">Submit</button>
                                                        </div>
                                                        </form>
           ...
           ?>
                            ...
                            <form method="POST" action="quiz_add.php">
                                <div class="form-group">
                                    ...
                                    <small id="emailHelp" class="form-text text-muted">please enter the
                                        question.</small>
                                </div>
