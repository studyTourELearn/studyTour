                        ...
                        <form method="POST" enctype="multipart/form-data" action="imgdemo.php">
                            <div class="form-group">
                                <div class="row form-inline">
                                    <input type="label" name="" value="Language Name :"
                                        style="margin-top: -60px; border: none;">
                                    <input type="text" name="languagename" class="form-control"
                                        style="position: absolute; top:20px; right:80px; width: 100px;">
                                </div>
                                <div class="row">
                                ...
                                <button id="btn-login" name="btn-add-course" type="submit" style="top: 200;">Add
                                    Course</button>
