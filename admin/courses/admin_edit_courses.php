			...
			while ($res=mysqli_fetch_array($result)) {
       		...
       		?>
                ...
                <tr class="text-white ">
                    ...
                    <td><textarea rows="3" cols="50" class="text-white"><?php echo $res['description']; ?></textarea>
                    </td>
                    <td><a class="text-white no-gutters"
                            href="update_course.php?course_id=<?php echo $res['id'] ?>">Update</a></td>
                    <td><a class="text-white no-gutters"
                            href="delete_topic.php?course_id=<?php echo $res['id'] ?>&amp;course_name=<?php echo $res['course_name']; ?>">Delete</a>
                    </td>
