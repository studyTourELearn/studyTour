...
<body onload="">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
        <a class="navbar-brand text-white" href="../admin_main.php">Study Tour</a>
	...
	?>
                            ...
                            <div class="card ml-5 mt-4" style="width: 18rem;">
                                <img class="card-img-top" src="../../<?php echo $course_list['language_image'] ?>"
                                    alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo $course_list['language_name']; ?> <a
                                            href="edit_topics.php?course_name=<?php echo $course_list['language_name']; ?>"
                                            class="h6 text-info float-right">edit topic <i
                                                    ...
                                                    <div class="card-body small">
                                                        ...
                                                        <form action="course_add.php" method="post"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label for="exampleFormControlSelect1">Select Course
                                                                    Name :</label>
