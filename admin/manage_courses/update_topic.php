      ...
      while ($res=mysqli_fetch_array($result)) {
          ...
          ?>
                ...
                <form method="POST" action="verify/verify_changes.php" class="ml-3">
                    ...
                    Enter course name:<input type="text" name="coursename" readonly="readonly" class="form-control"
                        value="<?php echo $res['course_name'] ?>"><br>
                    Enter topic name :<input type="text" name="topic_name" class="form-control"
                        value="<?php echo $res['topic_name'] ?>">

                    Enter the content:
                    <textarea id="editor" name="editor" class="ckeditor"
                        placeholder="Enter the content..."><?php echo $res['description']; ?></textarea>
